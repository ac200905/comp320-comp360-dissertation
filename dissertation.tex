...
\begin{itemize}
	\item \textit{Monitoring game statistics
	\item Defining adjustment actions and policies
	\item Executing those actions and policies
	\item Displaying data and system control settings}
\end{itemize}
...
4 & \begin{tabular}[c]{@{}l@{}}Players will be able to reliably judge which \\ version used dynamic difficulty\end{tabular}                                        & \begin{tabular}[c]{@{}l@{}}Players will be unable to reliably judge which \\ version used dynamic difficulty\end{tabular}                                               & Questionnaire                                                 \\ \hline
\end{tabular}
\end{table*}
